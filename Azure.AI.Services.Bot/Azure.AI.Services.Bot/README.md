...
- In a terminal, navigate to `Azure.AI.Services.Bot`

    ```bash
    # change into project folder
    cd Azure.AI.Services.Bot
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `Azure.AI.Services.Bot` folder
  - Select `Azure.AI.Services.Bot.csproj` file
